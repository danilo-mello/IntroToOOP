...
public class Test {
    public static void main(String[] args) {
        ...
        String x = inchesToMeters(1000);
        System.out.println(x);

        String y = addDigits(541);
        System.out.println(y);

        String z = minsToYearsDays(3456789);
        System.out.println(z);

        String a = bmi(70, 1.75);
        System.out.println(a);

        String b = speed(2500, 5, 56, 23);
        System.out.println(b);

        String c = powers(5);
        System.out.println(c);

        String d = arithmetic(25, 5);
    ...
    public static String arithmetic(int a, int b) {
        ...
        String result = String.format("Sum of two integers: %d\n" +
                ...
                "Max integer: %d\n" +
                "Min integer: %d", sum, dif, prod, ave, dist, max, min);
        return result;
    }
    ...
    public static String inchesToMeters(int inches) {
        ...
        String result = String.format("%d inches is %.1f meters", inches, meters);
        return result;
    }
